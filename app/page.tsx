...
const AnimatedDataFlow = () => (
  <>
    ...
    <div className="hidden md:flex w-12 h-[2px] bg-neutral-800 relative overflow-hidden shrink-0 mt-8">
      <motion.div
        animate={{ x: [-50, 50] }}
        transition={{ repeat: Infinity, duration: 1.5, ease: "linear" }}
        className="absolute top-0 left-0 w-1/2 h-full bg-gradient-to-r from-transparent via-emerald-500 to-transparent"
      />
    </div>
    {/* Mobile Vertical Line */}
    <div className="flex md:hidden h-8 w-[2px] bg-neutral-800 relative overflow-hidden shrink-0">
      <motion.div
        animate={{ y: [-32, 32] }}
        transition={{ repeat: Infinity, duration: 1.5, ease: "linear" }}
    ...
    "jobs": [
      {
        ...
        <div>
          ...
          <div className="w-full rounded-2xl border border-neutral-800 bg-[#0d0d0d] p-8 md:p-16 relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-center relative z-10">
