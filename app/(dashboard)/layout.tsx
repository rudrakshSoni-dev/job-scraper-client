    ...
    <div className="flex h-screen bg-gray-100 font-sans">
      ...
      {mobileMenuOpen && (
        <>
          ...
          {/* Drawer */}
          <aside className="fixed top-0 left-0 h-full w-64 bg-white z-50 shadow-lg md:hidden transition-transform duration-300">
            {/* Header */}
            <div className="p-6 text-black font-bold text-xl flex items-center justify-between">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <footer className="border-t border-gray-200 bg-white p-4 text-center text-sm text-gray-500">
          <div className="flex justify-center gap-4 mb-2">
            ...
            <a
              className="cursor-pointer hover:text-black"
              href="mailto:hello@rudrakshh.live"
            >
              Email
            </a>
            <a
