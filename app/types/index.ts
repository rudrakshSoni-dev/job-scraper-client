...
export interface Analysis { atsScore: number; keywordScore: number; sectionScore: number; skillScore: number; structureScore: number; semanticScore: number; experienceScore: number; impactScore: number; suggestions: {
  suggestions: any; rewriteTips: string[]; missingKeywords: string[] 
}; createdAt: string; }
